...
const RegistrationWidget = () => {
	...
	return (
		<div className={styles.wrapper}>
			...
			<Text type={'light'} fontSize={20}>или используйте другие данные </Text>
			<FormProvider {...methods}>
				<form id='registration' className={styles.inputs} onSubmit={handleSubmit(onSubmit)}>
					<TextInput name='login' width='400px' label='Логин'/>
					<TextInput name='password1' width='400px' label='Пароль' type='password'/>
					<TextInput name='password2' width='400px' label='Пароль' type='password'/>
				</form>
			</FormProvider>
			<button
			form='registration'
